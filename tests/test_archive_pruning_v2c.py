...
def test_prune_aborts_if_validated_parity_sidecar_changes_before_delete(
    db_path,
    tmp_path,
    monkeypatch,
):
    ...
    original_build = (
        pruning._build_plan_from_connection
    )

    def build_then_tamper(
        *args,
        **kwargs,
    ):
        plan = original_build(
